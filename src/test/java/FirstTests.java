...
public class FirstTests {
    ...
    public void selectFirstPodcast() {
        ...
        // Webelement linkpodcast = driver.findElemnt(by.cssSelcetor("#substories > a:first-child")
        // String linkToPodcastHref
        ...
        // znajdz record
        // kliknij record :)
        // zadanko 2: napisz na click meetingu, jak sprawdzic czy podkast jest "odpalony" XD
        // div zmienia nazwe klasy na record-wraper playing
...
//    @Test
//    public void taskBar() {
//        driver.get("https://dev.to/search");
//        WebElement element = driver.findElement(By.partialLinkText("Testing"));
//        element.click();
//        driver.findElement(By.xpath("//input[@id='btn-sendkeys']")).sendKeys("Testing");
//
//        //driver.findElement(By.xpath("//input[@id='textbar']")).sendKeys("Testing");
    }
